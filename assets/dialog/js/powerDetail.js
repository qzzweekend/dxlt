...
new Vue({
    ...
    methods: {
        ...
        showPsUnit: function () {
            ...
            var url = ctx + "dialog/dialog_psUnit.html?ps_id=" + dialog.ps_id + "&ps_scheme=" + dialog.ps_scheme;
    ...
    mounted: function () {
        this.getPsDetailInfo1();
        this.loadDataForRealTimePower();
        this.loadWeather();
    }
